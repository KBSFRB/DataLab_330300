const correction_module = (function () {
  ...
  function submit(data) {
    ...
    let url =
      "https://backend-330300.vandendriesche-c.workers.dev/add_correction";
  ...
  function show(map, layer) {
    ...
    document.getElementById("rule300-correction").checked =
      building_properties.r300 === 1 ? true : false;
